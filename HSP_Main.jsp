      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="HSP_ViewProfile.jsp">&raquo; View Profile </a></li>
            <li><a href="HSP_AddPatient.jsp">&raquo; Add Patient Details </a></li>
            <li><a href="HSP_DeletePatient.jsp">&raquo; View Patient Details </a></li>
			 <li><a href="HK_Key_Requests.jsp">&raquo;  View Key Requests </a></li>
            <li><a href="HSP_View_clinicalReport.jsp">&raquo; View Clinical Reports </a></li>
