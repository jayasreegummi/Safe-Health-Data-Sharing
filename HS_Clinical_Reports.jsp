...
.style44 {font-size: 14px; font-weight: bold; color: #FFFF00; }
-->
</style>
</head>
<body>
<div class="main">
  ...
  <div class="content">
          ...
          <div class="article">
            ...
            <div >
              ...
              <table width="580" border="1" cellpadding="0" style="border-collapse:collapse" cellspacing="0" align="center">
                <tr>
                  <td width="34" height="34" bgcolor="#FF0000"><div align="center" class="style22 style43"> ID </div></td>
                  <td width="126" bgcolor="#FF0000"><div align="center" class="style44">Patient Name </div></td>
                  <td width="132" bgcolor="#FF0000"><div align="center" class="style44">Provider Name </div></td>
                  <td width="143" bgcolor="#FF0000"><div align="center" class="style44">View Report </div></td>
                  <td width="133" bgcolor="#FF0000"><div align="center" class="style44">Status</div></td>
                </tr>
                <%
      	...
      	try 
	{
      		...
      		String query="select * from patient_reports  "; 
	...
	while ( rs.next() )
	   {
		...
		%>
                <tr>
                  ...
                  <td><div align="center">
                    <form action="HS_report.jsp" method="get">
                        <input type="hidden" name="patient" value="<%=s2%>" />
                        <input type="hidden" name="provider" value="<%=s3%>" />
                        <input name="Input" type="submit" value="View" />
                      </form>
                  </div></td>
				  <%if(s6.equalsIgnoreCase("server")){%>
                  <td><div align="center"><a href="HS_fwd_pat_Reports.jsp?id=<%=i%>">Forward To <%=s2%></a></div></td>
				  <%}else{%>
