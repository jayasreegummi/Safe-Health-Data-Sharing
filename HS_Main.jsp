  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            <h2><span>Welcome Healthcare Server </span></h2>
            <p class="infopost">&nbsp;</p>
            <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="HS_DocAutho.jsp">&raquo; Authorize PHR User </a></li>
            <li><a href="HS_ProviderAutho.jsp">&raquo; Authorize PHR DataOwner </a></li>
            <li><a href="HS_Clinical_Reports.jsp">&raquo; Clinical Report </a></li>
            <li><a href="HS_ViewDetails.jsp">&raquo; View Patient Details</a></li>
            <li><a href="HS_ViewAccessControl_req.jsp">&raquo; Access Control Req </a></li>
			
            <li><a href="HK_En_Key_Requests.jsp">&raquo; Encryption Key Requests </a></li>
            <li><a href="HS_Key_Transactions.jsp">&raquo; View Key Transactions</a></li>
            <li><a href="HS_Chart.jsp">&raquo; View Result in Chart </a></li>
