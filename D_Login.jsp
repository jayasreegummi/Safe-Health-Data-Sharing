...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="D_Login.jsp"><span>PHR Users</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>PHR User Login </span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div>
            <p align="center"><img src="images/Login.jpg" width="188" height="110" /></p>
            <form action="D_Authentication.jsp" method="post" id="leavereply">
              ...
              <p>New User? click here to <a href="D_Register.jsp"> Register</a><br />
              </p>
            </form>
