			...
			if ( rs.next() )
			{
				...
				%>
                        <table width="583" height="249" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="28" bgcolor="#FF0000"><div align="left" class="style44">Patient Name : </div></td>
                            <td width="395"  ><%=s2%>
                                </th>                            </td>
                          </tr>
                          <tr>
                            <td height="28" bgcolor="#FF0000"><div align="left" class="style44">Provider Name : </div></td>
                            <td  ><%=s3%>
                                </th>                            </td>
                          </tr>
                          <tr>
                            <td height="147" bgcolor="#FF0000" ><div align="left" class="style44">Enter Clinical Details : </div></td>
...
%>
                        ...
                        <p align="right"><a href="HSP_View_clinicalReport.jsp">Back</a></p>
          </div>
          <div class="clr"></div>
        </div>
      </div>
