...
try 
	{		
			...
			if ( rs.next() )
			{
				...
				<tr>
				<td height="28"><div align="left"><strong>Patient Name : </strong></div></td>
				<td width="395"  ><%=s2%>
				</th>				</td>
				</tr>
				<tr>
                  <td height="28"><div align="left"><strong>Provider Name : </strong></div></td>
				  <td  ><%=s3%>
                      </th>                  </td>
				  </tr>
				...
				<tr>
				<td height="147" ><div align="left"><strong>Enter Treatment Details : </strong></div></td>
			...
			%>
				...
				<tr>
					<td height="147" ><div align="left"><strong>Enter Report Details : </strong></div></td>
