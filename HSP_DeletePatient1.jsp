...
<div class="main">
  ...
  <div class="content">
	...
	try 
	{
			...
			String quer="delete from patient_details where patient_name='"+file+"' and downer='"+pname+"'";
			Statement st3=connection.createStatement();
			int rs3=st3.executeUpdate(quer);
			
			String quer4="delete from patient_details_backup where patient_name='"+file+"' and downer='"+pname+"'";
