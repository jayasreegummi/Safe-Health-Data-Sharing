  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            <h2><span>Authorize PHR Owner </span></h2>
            <p class="infopost">&nbsp;</p>
            <div class="clr"></div>
            <div >
              <p align="justify">&nbsp;</p>
              <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
                <tr>
                  ...
                  <td width="183" bgcolor="#FF0000"><div align="center" class="style25"> Provider  Name </div></td>
	...
	while ( rs.next() )
	   {
		...
		%>
                ...
                <tr>
                  ...
                  <td><div align="center"><a href="HS_ProviderDetails.jsp?name=<%=s2%>"><%=s2%></a></div></td>
                  <%	
		...
		%>
                  <td><div>
                      <div align="center"><a href="HS_StatusProvider.jsp?id=<%=i%>"><%=s5%></a></div>
                  </div></td>
                  <%
